...
export class RequestMintWithIXTCall extends ethereum.Call {
  get inputs(): RequestMintWithIXTCall__Inputs {
    return new RequestMintWithIXTCall__Inputs(this);
  }

  get outputs(): RequestMintWithIXTCall__Outputs {
    return new RequestMintWithIXTCall__Outputs(this);
  }
}

export class RequestMintWithIXTCall__Inputs {
...
export class RequestMintWithIXTCall__Outputs {
  _call: RequestMintWithIXTCall;
...
export class SafeMintCall__Inputs {
  ...
  get info(): SafeMintCallInfoStruct {
    return changetype<SafeMintCallInfoStruct>(
...
export class SetDropInfoCall__Inputs {
  ...
  get drop(): SetDropInfoCallDropStruct {
    return changetype<SetDropInfoCallDropStruct>(
      this._call.inputValues[1].value.toTuple()
    );
  }
}
